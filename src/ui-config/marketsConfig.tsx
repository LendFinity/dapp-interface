...
export const marketsData: {
  ...
  [CustomMarket.proto_lukso_v3]: {
    marketTitle: 'LUKSO',
    market: CustomMarket.proto_lukso_v3,
    v3: true,
  ...
  [CustomMarket.proto_lukso_testnet_v3]: {
    ...
    market: CustomMarket.proto_lukso_testnet_v3,
    v3: true,
    chainId: 4201 as ChainId,
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0x9a11eef3e52856e8CeD9CA96636F51D20Fb27fb5',
      LENDING_POOL: '0xc3C1F17055bCD252CBE02cF068598769677e1222',
      WETH_GATEWAY: '0x944061b57c8eB97771CEdb75cf605E8d39149d45',
      WALLET_BALANCE_PROVIDER: '0xd138c963c82AEb7baDe2DF283765284377e27424',
      UI_POOL_DATA_PROVIDER: '0x7133f6cb88506D709d44f15E93D3e36Ff01486E0',
      //
      // LENDING_POOL_ADDRESS_PROVIDER: '0x7cE75E2609F1e5C94B0EC9c7B0A46ffD20551982',
      // LENDING_POOL: '0xc9bb76F57fC205458235Bb7E4484493C998dB9c3',
      // WETH_GATEWAY: '0x940062bEC07697C110d6e5dd08473891fD4CF176',
      // WALLET_BALANCE_PROVIDER: '0x9a68D8E61f2aA632F0575ff3946Ca0DdEafB8885',
      // UI_POOL_DATA_PROVIDER: '0xda303B11b98b51Fca6718F06380feE2B6290B1D1',
      //
      // LENDING_POOL_ADDRESS_PROVIDER: '0xBeB703083B3a558932BE88d63a4112e6EC7Ca7C6',
      // LENDING_POOL: '0x08Eb8B7B9B00Ed1c303aaA97d50EE02FCBb2fDf3',
      // WETH_GATEWAY: '0x6AFa04D59DDe88Cc580968e06408825b3e4DF6D2',
      // WALLET_BALANCE_PROVIDER: '0x1E8fbe09b1924f6Bb1496630bE6C1c5D3edC6955',
      // UI_POOL_DATA_PROVIDER: '0x05EBf12991b5DB80BD89d2AAcD711C1C6FB20D0F',
      //
      // LENDING_POOL_ADDRESS_PROVIDER: '0x606456d9BC2E8beE968f8f1b6FAD48a44ECe0C64',
      // LENDING_POOL: '0xdF275B2a53ffa15eE9Ed8a1e6d237fEa9185b6db',
      // WETH_GATEWAY: '0xF683103D40eC9E97bcB371cF273F5Ff20af128B9',
      // WALLET_BALANCE_PROVIDER: '0x8622e5F0e1BF9088271fa3011bf385fD189B40F4',
      // UI_POOL_DATA_PROVIDER: '0xF76A1320b9705219f6C15B174813074dEf83482f',
    },
  },
  [CustomMarket.proto_bitfinity_v3]: {
    ...
    addresses: {
      ...
      WETH_GATEWAY: '0xA4A32488C6517f26d6a902008C9bc43F3e96435f',
  ...
  [CustomMarket.proto_bitfinity_testnet_v3]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0xA388228A1fA75a5F5844226E2874d7EE4d940256',
      LENDING_POOL: '0xD8B9c8934049Ed80f497489f9eE5139aa044FC0e',
      WETH_GATEWAY: '0x81B2b28442e743954C8678b0d2e4be396976F561',
      WALLET_BALANCE_PROVIDER: '0xfd3Cb0fFE63B1fDBBE257b9AdFCCC065f300C829',
      UI_POOL_DATA_PROVIDER: '0x7f3fF452D3da0EAD3ce227eB4A6c84E896685C3C',
    },
  },
