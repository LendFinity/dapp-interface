...
export const networkConfigs: Record<string, BaseNetworkConfig> = {
  ...
  42: {
    name: 'Lukso',
    publicJsonRPCUrl: ['https://rpc.mainnet.lukso.network, https://rpc.lukso.sigmacore.io'],
    baseAssetSymbol: 'LYX',
  ...
  10143: {
    name: 'Monad Testnet',
    publicJsonRPCUrl: ['https://monad-testnet.drpc.org'],
    baseAssetSymbol: 'MON',
    wrappedBaseAssetSymbol: 'WMON',
    baseAssetDecimals: 18,
    explorerLink: 'https://testnet.monadexplorer.com/',
    isTestnet: true,
