        ...
        <Box mb={4}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', mb: 4 }}>
            ...
            <Typography
              ...
              sx={{ ml: 2, mr: 3 }}
            >
              <Trans>Lendfinity Governance</Trans>
            </Typography>
          </Box>

          <Typography sx={{ color: '#8E92A3', maxWidth: '824px' }}>
            <Trans>
              Lendfinity is a fully decentralized, community governed protocol by the LEND
              token-holders. LEND token-holders collectively discuss, propose, and vote on upgrades
              to the protocol. LEND token-holders (Ethereum network only) can either vote themselves
